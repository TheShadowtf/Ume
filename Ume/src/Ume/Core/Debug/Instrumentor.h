...
#define UME_PROFILE 1
	...
	#define UME_PROFILE_FUNC() UME_PROFILE_SCOPE(__FUNCSIG__)
#else
	#define UME_PROFILE_BEGIN_SESSION(name, filepath)
	#define UME_PROFILE_END_SESSION()
	#define UME_PROFILE_SCOPE(name)
	#define UME_PROFILE_FUNC()
#endif