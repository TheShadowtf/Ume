...
namespace Ume
{
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		UME_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Frambuffer is incomplete!");
	...
	void OpenGLFramebuffer::Resize(uint32_t width, uint32_t height)
	{
		...
		{
			UME_CORE_WARN("Attempted to resize framebuffer to {0}, {1}", width, height);
			return;
		}
